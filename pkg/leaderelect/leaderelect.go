...
//
// The wrapper acquires a namespaced Lease, spawns the given command in its own
// process group while holding leadership, reaps orphaned children (PID 1), and
// on SIGTERM/SIGINT or leadership loss stops the child group before releasing
...
// Cmd returns the leader-elect CLI command.
