...
const Sha256_deploy_obc_lib_bucket_provisioner_v1_0_0_clusterserviceversion_yaml = "695141c74931e66aa478d7d646f2c933fb09a10db7440799e8652ba6a222c8e2"
...
metadata:
  ...
  annotations:
    ...
    alm-examples: |-
      [
        {
          "apiVersion": "objectbucket.io/v1alpha2",
...
const Sha256_deploy_obc_objectbucket_io_objectbucketclaims_crd_yaml = "fd0f22ff017f0285c2904c55b17bbbf64566fd3c0b5f81ca6fc46756c46a127b"
...
const Sha256_deploy_obc_objectbucket_io_objectbuckets_crd_yaml = "cc46ca2022dd7f22279caeeff51acac1aa1cf9eaa0e8fd24e239529194e97c95"
...
const Sha256_deploy_obc_objectbucket_v1alpha1_objectbucket_cr_yaml = "5ac363c441ce7bf20d52cdebc7ec5f052dd35bb5f2dce57b42ffd346f5c6cfc5"

const File_deploy_obc_objectbucket_v1alpha1_objectbucket_cr_yaml = `apiVersion: objectbucket.io/v1alpha2
kind: ObjectBucket
metadata:
  name: my-obc
spec:
...
const Sha256_deploy_obc_objectbucket_v1alpha1_objectbucketclaim_cr_yaml = "a776a42019f422e7776cd1b2046aa5a5f84364cbdb8801e577bb038b339e6f35"

const File_deploy_obc_objectbucket_v1alpha1_objectbucketclaim_cr_yaml = `apiVersion: objectbucket.io/v1alpha2
kind: ObjectBucketClaim
metadata:
  name: my-obc
  namespace: my-app
